...
class CX3DViewportNode(CX3DGroupingNode):
    ...
    # turn array of 3-tuple float results array [] from SFVec3f initializeOnly field named "bboxCenter"
    def getBboxCenter1 (self):
        pass

    # Assign 3-tuple float array [] to SFVec3f initializeOnly field named "bboxCenter"
    def setBboxCenter1 (self, value):
        pass
    ...
    def setMetadata2 (self, protoInstanc):
        pass