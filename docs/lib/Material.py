...
class CMaterial(CX3DMaterialNode):
    ...
    def setEmissiveColor2(self, val):
        self.emissiveColor[0] = val.x()
        self.emissiveColor[1] = val.y()
        self.emissiveColor[2] = val.z()
    ...
    def setSpecularColor2(self, val):
        self.specularColor[0] = val.x()
        self.specularColor[1] = val.y()
        self.specularColor[2] = val.z()
