...
# Form implementation generated from reading ui file 'TransformDialogue.ui'
#
...
class TransformDialogue(QtWidgets.QDialog):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    def setupUi(self, Dialog):
        ...
        self.translation_xLineEdit = QtWidgets.QLineEdit(self.groupBox_4)
        self.translation_xLineEdit.setObjectName("translation_xLineEdit")
        self.verticalLayout_9.addWidget(self.translation_xLineEdit)
        self.translation_yLineEdit = QtWidgets.QLineEdit(self.groupBox_4)
        self.translation_yLineEdit.setObjectName("translation_yLineEdit")
        self.verticalLayout_9.addWidget(self.translation_yLineEdit)
        self.translation_zLineEdit = QtWidgets.QLineEdit(self.groupBox_4)
        self.translation_zLineEdit.setObjectName("translation_zLineEdit")
        self.verticalLayout_9.addWidget(self.translation_zLineEdit)
        ...
        self.rotation_xLineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.rotation_xLineEdit.setObjectName("rotation_xLineEdit")
        self.verticalLayout_12.addWidget(self.rotation_xLineEdit)
        self.rotation_yLineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.rotation_yLineEdit.setObjectName("rotation_yLineEdit")
        self.verticalLayout_12.addWidget(self.rotation_yLineEdit)
        self.rotation_zLineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.rotation_zLineEdit.setObjectName("rotation_zLineEdit")
        self.verticalLayout_12.addWidget(self.rotation_zLineEdit)
        self.rotation_angleLineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.rotation_angleLineEdit.setObjectName("rotation_angleLineEdit")
        self.verticalLayout_12.addWidget(self.rotation_angleLineEdit)
        ...
        self.scale_xLineEdit = QtWidgets.QLineEdit(self.groupBox_14)
        self.scale_xLineEdit.setObjectName("scale_xLineEdit")
        self.verticalLayout_5.addWidget(self.scale_xLineEdit)
        self.scale_yLineEdit = QtWidgets.QLineEdit(self.groupBox_14)
        self.scale_yLineEdit.setObjectName("scale_yLineEdit")
        self.verticalLayout_5.addWidget(self.scale_yLineEdit)
        self.scale_zLineEdit = QtWidgets.QLineEdit(self.groupBox_14)
        self.scale_zLineEdit.setObjectName("scale_zLineEdit")
        self.verticalLayout_5.addWidget(self.scale_zLineEdit)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Transform Node Dialogue"))
        self.groupBox.setTitle(_translate("Dialog", "Fields"))
        self.groupBox_3.setTitle(_translate("Dialog", "translation"))
        self.label.setText(_translate("Dialog", "X"))
        self.label_2.setText(_translate("Dialog", "Y"))
        self.label_3.setText(_translate("Dialog", "Z"))
        self.groupBox_5.setTitle(_translate("Dialog", "rotation"))
        ...
        self.groupBox_13.setTitle(_translate("Dialog", "scale"))
        ...
        self.groupBox_4.setTitle(_translate("Dialog", "translation"))
        self.groupBox_6.setTitle(_translate("Dialog", "rotation"))
        self.groupBox_14.setTitle(_translate("Dialog", "scale"))
